...
|---|---|---|---|---|---|
| Seller | Camille Dizon | +639178642310 | VeribeeTest123! | LuxeLane Manila, Makati, VSI 96, KYC complete | Can enter the seller dashboard and manage preloaded sample products. |
| Buyer | Nico Villanueva | +639178642311 | VeribeeTest123! | BGC buyer, high-value handover requires OTP | Can enter the buyer home feed, view authentication reports, cart products, and checkout. |
| Rider | Paolo Reyes | +639178642312 | VeribeeTest123! | Honda Click 125i rider, rating 4.9, KYC complete | Can enter the rider job feed and complete the local delivery loop. |
...
| Structured Leather Tote MM | Bags | PHP 12,990 | Verified | 96 | OTP |
